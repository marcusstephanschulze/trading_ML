...
live_time_interval = '30m' #needs to be different because yfinance requires different string from alphavantage 
...
def technical_indicators(iterator): #run at the end of every trading day. remove iterator later, it is not needed
    ...
    for file in dir_list[0:iterator]:
